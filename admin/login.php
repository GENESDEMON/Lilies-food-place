          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                  <a class="nav-link me-2" href="add_admin.php">
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <p class="mb-0">Hey there admin, you have orders to be processed</p>
                </div>
                <div class="card-body">
                <form role="form" method="post" action="login.php" autocomplete="off">
                  <?php include('../includes/errors.php'); ?>
                    ...
                    <div class="text-center">
                      <button type="submit" name="admin_login" class="btn bg-gradient-info w-100 mt-4 mb-0">Sign in</button>
                    </div>
                  </form>
                </div>
              </div>
